    ...
    <form action="page2.php">
        ...
        if ($result) {
            ...
            for ($i = 0; $i < $rows; ++$i) {
                ...
                for ($j = 0; $j < 2; ++$j) {
                    if ($j == 1)
                        echo  "<td ><input type='text'  class='input-td' name='m$i' value='$row[$j]' autocomplete='off' title='нажмите для изменения'></td>";
                    else
            ...
            echo "</table>";
            echo "<input type='submit' value='Изменить' class='ok-btn' title='сохранить изменённые данные'>";
